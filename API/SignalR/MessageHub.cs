...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            var sender = await _userRepository.GetUserByUsernameAsync(username); //expeditor
            var recipient = await _userRepository.GetUserByUsernameAsync(createMessageDto.RecipientUsername); //destinatar
